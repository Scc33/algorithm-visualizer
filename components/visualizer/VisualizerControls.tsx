...
export default function VisualizerControls({
  ...
  const newDataButtonText = algorithmCategory === "graph" ? "New Graph" : "New Array";
  ...
  return (
    <div className="card p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        {isPlaying ? (
          <button onClick={handlePause} className="btn btn-danger flex items-center space-x-2 cursor-pointer">
            {PauseIcon}
            <span>Pause</span>
          </button>
        ) : (
      ...
      <div className="flex flex-col">
        <label className="text-sm font-medium text-gray-700 mb-1" id="speed-label">
          Animation Speed
        </label>
        <input
          type="range"
