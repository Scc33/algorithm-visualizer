        ...
        {orderedDifficulties.map((difficulty) => {
          ...
          const cardProps = {
            easy: {
              ...
              icon: "✓",
              description:
                "Perfect for beginners learning the basics of algorithms.",
            },
            medium: {
              ...
              icon: "⚠",
              description:
                "Intermediate algorithms that build on basic concepts.",
            },
            hard: {
              ...
              icon: "!",
              description:
                "Advanced algorithms that require deeper understanding.",
            },
          }[difficulty];
